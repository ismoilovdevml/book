...
Bundan avvalroq **[OpenVPN tunnel orqali dinamik IPdagi serverga reverse proxy qilish](/tutorials/article/dinamik-to-static)** haqida yozgandim. Bugun esa xuddi shuni davom ettiramiz. 
