...
Oldingi [**ELK Stackga kirish**](/guides/monitoring/elk-stack) mavzusida biz ELK nimaga ishlatilishi uning arxitekturasi va componentlari, qanday ishlashini ko'rib chiqgan edik. Bugungi amaliyotimizda biz **ELK stack Cluster** sozlashni ko'rib chiqamiz.
<Callout type="info" emoji="">
**Diqqat!** 
* Ushbu amaliyotni boshlash uchun [**ELK Stackga kirish**](/guides/monitoring/elk-stack) qo'llanmasini o'qib chiqgan bo'lishingiz kerak bo'ladi!
 ...
 * [**ELK Stackga kirish**](/guides/monitoring/elk-stack)
 * [**APM Server Sozlash**](/guides/monitoring/apm-server-sozlash)
