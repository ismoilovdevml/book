...
**Diqqat!** 
* Ushbu amaliyotni boshlash uchun [**ELK Stackga kirish**](/guides/monitoring/elk-stack) va  [**ELK Stack Cluster o'rnatish va sozlash**](/guides/monitoring/elk-setup) qo'llanmasini o'qib chiqgan bo'lishingiz kerak bo'ladi!
...
Keling [**ELK Stack Cluster o'rnatish va sozlash**](/guides/monitoring/elk-setup) qo'llanmasidagi app-server(`10.128.0.12`) ga APM Server o'rnatamiz.
...
* [**ELK Stack Cluster o'rnatish va sozlash**](/guides/monitoring/elk-setup)
